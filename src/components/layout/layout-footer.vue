<template>
    <div id="layout-footer">
        ...
        <div class="copyright">Copyright © 2020 by <a target="_blank" class="out-link" href="https://www.lishuqi.top">lishuqi.top</a> . All rights reserved. | <a target="_blank" class="out-link" href="http://www.beian.miit.gov.cn">湘ICP备2020021755号-1</a></div>
    </div>
</template>
